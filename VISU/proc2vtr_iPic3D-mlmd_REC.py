...
dirName = sys.argv[1]
GN_i = sys.argv[2]
first_cycle_i= sys.argv[3]
last_cycle_i= sys.argv[4]
step_i= sys.argv[5]

print "asdasda " + str(GN_i)
GN= int(GN_i)
first_cycle= int(first_cycle_i)
last_cycle= int(last_cycle_i)
step= int(step_i)
...
print "Data received: dirName " + dirName + " GN " + str(GN) + " first_cycle " + str(first_cycle) + " last_cycle " + str(last_cycle) + " step " + str(step)
# Directory of the simulation data                                                                 
directory= dirName
out_directory= dirName +"data_vtr" + str(GN)
