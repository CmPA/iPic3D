...
template <class type>
type ****_new_4_array(int sz1, int sz2, int sz3, int sz4)
{
...
template <class type>
type ****_assign_4_array(int sz1, int sz2, int sz3, int sz4, type ****org)
{
...
template <class type>
void delArr4(type ****arr, int dummyx, int dummyy, int dummyz)
{
  delete [] arr[0][0][0];
  delete [] arr[0][0];
  delete [] arr[0];
...
template <class type>
type ***_new_3_array(int sz1, int sz2, int sz3)
{
...
template <class type>
type ***_assign_3_array(int sz1, int sz2, int sz3, type ***org)
{
...
template <class type>
void delArr3(type ***arr, int dummyx, int dummyy)
{
  delete [] arr[0][0];
  delete [] arr[0];
  delete [] arr;
...
template <class type>
type **_new_2_array(int sz1, int sz2)
{
...
template <class type>
type **_assign_2_array(int sz1, int sz2, type **org)
{
...
template <class type>
void delArr2(type **arr, int dummyx)
{
  delete [] arr[0];
  delete [] arr;
}
