...
int main (int argc, char **argv) {
   ...
   printf( "Hello world from process %d of %d\n", rank, size );
    ...
    circshift(EX, AZ, xshift, yshift, zshift);
    circshift(EY, AZ, xshift, yshift, zshift);
    circshift(EZ, AZ, xshift, yshift, zshift);
    writeVTKvect_binary(it, "E", "", EX, EY, EZ);

	//Magnetic field
    readvect(it,"/fields/","B", BX, BY, BZ);
    circshift(BX, AZ, xshift, yshift, zshift);
    circshift(BY, AZ, xshift, yshift, zshift);
    circshift(BZ, AZ, xshift, yshift, zshift);
    ...
    circshift(NE, AZ, xshift, yshift, zshift);
    circshift(NI, AZ, xshift, yshift, zshift);
    if (ns >4) circshift(NO, AZ, xshift, yshift, zshift);
    if (ns >4) writeVTKscalar_species_binary(it,"rho", NE, NI, NO);
    else writeVTKscalar_species_binary(it,"rho", NE, NI);
 ...
 //   writeVTKvect(it,"JHarris", "e", VX, VY, VZ);
    ...
    circshift(VX, AZ, xshift, yshift, zshift);
    circshift(VY, AZ, xshift, yshift, zshift);
    circshift(VZ, AZ, xshift, yshift, zshift);
    ...
    circshift(TXX, AZ, xshift, yshift, zshift);
    circshift(TXY, AZ, xshift, yshift, zshift);
    circshift(TXZ, AZ, xshift, yshift, zshift);
    circshift(TYY, AZ, xshift, yshift, zshift);
    circshift(TYZ, AZ, xshift, yshift, zshift);
    circshift(TZZ, AZ, xshift, yshift, zshift);
