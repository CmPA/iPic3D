...
void writeVTKvect(string vectname, string addname, double** EX, double** EY,double** EZ) {
	...
	my_fileE << "DIMENSIONS " << nxn*XLEN << " " << nlevels << " " << 1 << endl;
	my_fileE << "ORIGIN " << 0.0 << " " << 0.0 << " " << 0.0 << endl;
	my_fileE << "SPACING " << dx << " " << dx*nxn*XLEN/nlevels << " " << 1.0 << endl;
	my_fileE << "POINT_DATA " << nxn*XLEN*nlevels << endl;
...
void writeVTKscalar(string scalarname, string addname, double** EX) {
	...
	my_fileE << "DIMENSIONS " << nxn*XLEN << " " << nlevels << " " << 1 << endl;
	my_fileE << "ORIGIN " << 0.0 << " " << 0.0 << " " << 0.0 << endl;
	my_fileE << "SPACING " << dx << " " << dx*nxn*XLEN/nlevels << " " << dz << endl;
	my_fileE << "POINT_DATA " << nxn*XLEN*nlevels << endl;
