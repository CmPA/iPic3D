...
class EMfields3D                // :public Field
{
  ...
  friend class OutputChunks;
    ...
    void initDoublePeriodicHarrisNoPerturbation(VirtualTopology3D * vct, Grid * grid, Collective *col);
    ...
    void initAsymmetric(VirtualTopology3D * vct, Grid * grid, Collective *col); 
    ...
    /*! Papini's turbulence initialization, perturbation in the xy plane */
    void alfredo_turbulence(VirtualTopology3D * vct, Grid * grid, Collective *col);
    /*! Papini's turbulence initialization, perturbation in the yz plane */
    void alfredo_turbulence_yz(VirtualTopology3D * vct, Grid * grid, Collective *col);
    /*! initGEM, two current sheets */
