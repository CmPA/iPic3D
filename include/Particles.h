...
public:
  /** allocate particles */
  virtual void allocate(int species, long long nop_init, Collective * col, VirtualTopology3D * vct, Grid * grid) = 0;
  ...
  virtual const double *getXall() const = 0;
  /** get Y-position array for all the particles */
  virtual const double *getYall() const = 0;
  /** get Z-position array for all the particles */
  virtual const double *getZall() const = 0;
  /** get u (X-velocity) array for all the particles */
  virtual const double *getUall() const = 0;
  /** get v (Y-velocity) array for all the particles */
  virtual const double *getVall() const = 0;
  /** get w (Z-velocity) array for all the particles */
  virtual const double *getWall() const = 0;
  /**get charge of particle array */
  virtual const double *getQall() const = 0;
  /** get ID array for all the particles */
  virtual const unsigned long long *getParticleIDall() const = 0;
  ...
  virtual unsigned long long getParticleID(long long indexPart) const = 0;
