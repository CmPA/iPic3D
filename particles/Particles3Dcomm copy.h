...
class Particles3Dcomm : public Particles {
  public:
	 ...
	 int unbufferX(double* b1right, double* b1left, double* b2Yright, double* b2Yleft, double* b2Zright, double* b2Zleft, VirtualTopology3D* ptVCT);
	 /** This unbuffer the first and second communication the BUFFER from Y direction*/
     int unbufferY(double* b1right, double* b1left, double* b2Xright, double* b2Xleft, double* b2Zright, double* b2Zleft, VirtualTopology3D* ptVCT);
	 /** This unbuffer the first and second communication the BUFFER from Y direction*/
     int unbufferZ(double* b1right, double* b1left, double* b2Xright, double* b2Xleft, double* b2Yright, double* b2Yleft, VirtualTopology3D* ptVCT);
  ...
  protected:
	...
	/** 2nd buffer with particles going to the right processor - Direction X */
    double *b_X_RIGHT_2;
    /** 2nd pointer to the buffer for resizing */
    double *b_X_LEFT_2;
    /** 2nd buffer with particles going to the right processor - Direction Y */
    double *b_Y_RIGHT_2;
    /** 2nd buffer with particles going to the left processor - Direction Y */
    double *b_Y_LEFT_2;
	/** 2nd buffer with particles going to the right processor - Direction Z */
    double *b_Z_RIGHT_2;
    /** 2nd buffer with particles going to the left processor - Direction Z */
    double *b_Z_LEFT_2;
	
	/** 3rd buffer with particles going to the right processor - Direction X */
    double *b_X_RIGHT_3;
    /** 3rd pointer to the buffer for resizing */
    double *b_X_LEFT_3;
    /** 3rd buffer with particles going to the right processor - Direction Y */
    double *b_Y_RIGHT_3;
    /** 3rd buffer with particles going to the left processor - Direction Y */
    double *b_Y_LEFT_3;
	/** 3rd buffer with particles going to the right processor - Direction Z */
    double *b_Z_RIGHT_3;
    /** 3rd buffer with particles going to the left processor - Direction Z */
    double *b_Z_LEFT_3;
