...
global color_choice symmetric_color labelx labely labelc reversex Ncycle cyl
cyl=1;
reversex=0;signx=1;
symmetric_color=1;
color_choice =3;
...
labelc = 'c.u.'; range=[-1 1]*0.3
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(JdotE(ir,jr,kr),3)*nWm3,AAz(ir,jr),['JE Y=' num2str((z(1,1,iz)))],'JE',range, Nsm,1+iz);
range=range*3
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(divS(ir,jr,kr),3)*nWm3,AAz(ir,jr),['divS Y=' num2str((z(1,1,iz)))],'divS',range, Nsm,1+iz);
...
tmp=common_image((X(jr,ir)),(Y(jr,ir)),signx*mean(Sx(ir,jr,kr),3)*1e3,AAz(ir,jr) ,['Sx Y=' num2str((z(1,1,iz)))],'Sx',range, Nsm, 2+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Sy(ir,jr,kr),3)*1e3,AAz(ir,jr) ,['Sy Y=' num2str((z(1,1,iz)))],'Sy',range, Nsm, 3+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Sz(ir,jr,kr),3)*1e3,AAz(ir,jr) ,['Sz Y=' num2str((z(1,1,iz)))],'Sz',range, Nsm, 4+iz);
...
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Sperp1(ir,jr,kr),3)*1e3,AAz(ir,jr) ,['S \perp_1 Y=' num2str((z(1,1,iz)))],'Sperp1',range, Nsm, 2+iz);
Sperp2=perp2x.*Sx+perp2y.*Sy+perp2z.*Sz;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Sperp2(ir,jr,kr),3)*1e3,AAz(ir,jr) ,['S \perp_2 Y=' num2str((z(1,1,iz)))],'Sperp2',range, Nsm, 2+iz);
...
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qenthepar(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qenthe || Y=' num2str((z(1,1,iz)))],'Qenthepar',range, Nsm, 2+iz);
Qentheperp1=(By.*Qenthex-Bx.*Qenthey)./B2D;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qentheperp1(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qenth \perp_1 Y=' num2str((z(1,1,iz)))],'Qentheprp1',range, Nsm, 2+iz);
Qentheperp2=perp2x.*Qenthex+perp2y.*Qenthey+perp2z.*Qenthez;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qentheperp2(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qenth \perp_2 Y=' num2str((z(1,1,iz)))],'Qentheprp2',range, Nsm, 2+iz);


Qbulkepar= dot(Qbulkex,Qbulkey,Qbulkez,Bx,By,Bz)./B;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qbulkepar(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qbulke || Y=' num2str((z(1,1,iz)))],'Qbulkepar',range, Nsm, 2+iz);
Qbulkeperp1=(By.*Qbulkex-Bx.*Qbulkey)./B2D;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qbulkeperp1(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qbulk \perp_1 Y=' num2str((z(1,1,iz)))],'Qbulkeprp1',range, Nsm, 2+iz);
Qbulkeperp2=perp2x.*Qbulkex+perp2y.*Qbulkey+perp2z.*Qbulkez;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qbulkeperp2(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qbulk \perp_2 Y=' num2str((z(1,1,iz)))],'Qbulkeprp2',range, Nsm, 2+iz);
...
Nsm=10
labelc = 'c.u.';labelc = 'c.u.'; range=[-1 1]*0.1
%tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(UdivPi(ir,jr,kr),3)*nWm3,AAz(ir,jr) ,['UdivPi Y=' num2str((z(1,1,iz)))],'UdivPi',range, Nsm, 2+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(udivPe(ir,jr,kr),3)*nWm3,AAz(ir,jr) ,['UdivPe Y=' num2str((z(1,1,iz)))],'UdivPe',range, Nsm, 2+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(udivPetrace(ir,jr,kr),3)*nWm3,AAz(ir,jr) ,['UdivPetrace Y=' num2str((z(1,1,iz)))],'UdivPetrace',range, Nsm, 2+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(udivPedev(ir,jr,kr),3)*nWm3,AAz(ir,jr) ,['UdivPedev Y=' num2str((z(1,1,iz)))],'UdivPedev',range, Nsm, 2+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(JedotEsm(ir,jr,kr),3)*nWm3,AAz(ir,jr),['JeE Y=' num2str((z(1,1,iz)))],'JeE',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(divQbulke(ir,jr,kr),3)*nWm3,AAz(ir,jr),['divQbulke Y=' num2str((z(1,1,iz)))],'divQbulke',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(divQenthe(ir,jr,kr),3)*nWm3,AAz(ir,jr),['divQenthe Y=' num2str((z(1,1,iz)))],'divQenthe',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(divQhfe(ir,jr,kr),3)*nWm3,AAz(ir,jr),['divQhfe Y=' num2str((z(1,1,iz)))],'divQhfe',range, Nsm,1+iz);
range=[-1 1]*0.1
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(-divQhfe(ir,jr,kr)-divQenthe(ir,jr,kr)+udivPe(ir,jr,kr),3)*nWm3,AAz(ir,jr),['dUthe Y=' num2str((z(1,1,iz)))],'dUthe',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(JedotE(ir,jr,kr)-divQbulke(ir,jr,kr)-udivPe(ir,jr,kr),3)*nWm3,AAz(ir,jr),['dUbulke Y=' num2str((z(1,1,iz)))],'dUbulke',range, Nsm,1+iz);

end

if(ions)
labelc = 'c.u.';range=[-1 1]*0.0
...
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qenthipar(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qenthi || Y=' num2str((z(1,1,iz)))],'Qenthipar',range, Nsm, 2+iz);
Qenthiperp1=(By.*Qenthix-Bx.*Qenthiy)./B2D;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qenthiperp1(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qenth \perp_1 Y=' num2str((z(1,1,iz)))],'Qenthiprp1',range, Nsm, 2+iz);
Qenthiperp2=perp2x.*Qenthix+perp2y.*Qenthiy+perp2z.*Qenthiz;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qenthiperp2(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qenth \perp_2 Y=' num2str((z(1,1,iz)))],'Qenthiprp2',range, Nsm, 2+iz);


Qbulkipar= dot(Qbulkix,Qbulkiy,Qbulkiz,Bx,By,Bz)./B;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qbulkipar(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qbulki || Y=' num2str((z(1,1,iz)))],'Qbulkipar',range, Nsm, 2+iz);
Qbulkiperp1=(By.*Qbulkix-Bx.*Qbulkiy)./B2D;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qbulkiperp1(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qbulk \perp_1 Y=' num2str((z(1,1,iz)))],'Qbulkiprp1',range, Nsm, 2+iz);
Qbulkiperp2=perp2x.*Qbulkix+perp2y.*Qbulkiy+perp2z.*Qbulkiz;
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(Qbulkiperp2(ir,jr,kr),3)*mWm2,AAz(ir,jr) ,['Qbulk \perp_2 Y=' num2str((z(1,1,iz)))],'Qbulkiprp2',range, Nsm, 2+iz);
...
Nsm=10
labelc = 'c.u.';range=[-1 1]*0.1
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(udivPi(ir,jr,kr),3)*nWm3,AAz(ir,jr) ,['UdivPi Y=' num2str((z(1,1,iz)))],'UdivPi',range, Nsm, 2+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(udivPitrace(ir,jr,kr),3)*nWm3,AAz(ir,jr) ,['UdivPitrace Y=' num2str((z(1,1,iz)))],'UdivPitrace',range, Nsm, 2+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(udivPidev(ir,jr,kr),3)*nWm3,AAz(ir,jr) ,['UdivPidev Y=' num2str((z(1,1,iz)))],'UdivPidev',range, Nsm, 2+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(JidotE(ir,jr,kr),3)*nWm3,AAz(ir,jr),['JiE Y=' num2str((z(1,1,iz)))],'JiE',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(divQbulki(ir,jr,kr),3)*nWm3,AAz(ir,jr),['divQbulki Y=' num2str((z(1,1,iz)))],'divQbulki',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(divQenthi(ir,jr,kr),3)*nWm3,AAz(ir,jr),['divQenthi Y=' num2str((z(1,1,iz)))],'divQenthi',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(divQhfi(ir,jr,kr),3)*nWm3,AAz(ir,jr),['divQhfi Y=' num2str((z(1,1,iz)))],'divQhfi',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(-divQhfi(ir,jr,kr)-divQenthi(ir,jr,kr)+udivPi(ir,jr,kr),3)*nWm3,AAz(ir,jr),['dUthi Y=' num2str((z(1,1,iz)))],'dUthi',range, Nsm,1+iz);
tmp=common_image((X(jr,ir)),(Y(jr,ir)),mean(JidotE(ir,jr,kr)-divQbulki(ir,jr,kr)-udivPi(ir,jr,kr),3)*nWm3,AAz(ir,jr),['dUbulki Y=' num2str((z(1,1,iz)))],'dUbulki',range, Nsm,1+iz);
