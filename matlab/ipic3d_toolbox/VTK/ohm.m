...
h=figure(1);
set(h,'Position' , [5 5 560 420]);
coplot(it,xx,yy,dPx,ay,'x/d_i','y/d_i','dPoy_x',lmt)
close all

disp('f1')
h=figure(1);
set(h,'Position' , [5 5 560 420]);
coplot(it,xx,yy,dPy,ay,'x/d_i','y/d_i','dPoy_y',lmt)
close all

disp('f1')
h=figure(1);
set(h,'Position' , [5 5 560 420]);
coplot(it,xx,yy,dPz,ay,'x/d_i','y/d_i','dPoy_z',lmt)
close all
...
h=figure(1);
set(h,'Position' , [5 5 560 420]);
coplot(it,xx,yy,Px,ay,'x/d_i','y/d_i','Poy_x',lmt)
close all

disp('f1')
h=figure(1);
set(h,'Position' , [5 5 560 420]);
coplot(it,xx,yy,Py,ay,'x/d_i','y/d_i','Poy_y',lmt)
close all

disp('f1')
h=figure(1);
set(h,'Position' , [5 5 560 420]);
coplot(it,xx,yy,Pz,ay,'x/d_i','y/d_i','Poy_z',lmt)
close all
