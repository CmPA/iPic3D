...
curlbx=reshape(curlbx(1:n1*27),27,n1);
curlby=reshape(curlby(1:n1*27),27,n1);
curlbz=reshape(curlbz(1:n1*27),27,n1);
...
CURLBX=[CURLBX ;curlbx(isat,1:n1sat)];
CURLBY=[CURLBY ;curlby(isat,1:n1sat)];
CURLBZ=[CURLBZ ;curlbz(isat,1:n1sat)];
end
SSX=EEY.*BBZ-EEZ.*BBY;
SSY=EEZ.*BBX-EEX.*BBZ;
SSZ=EEX.*BBY-EEY.*BBX;
