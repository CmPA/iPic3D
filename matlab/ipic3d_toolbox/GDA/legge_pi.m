...
TeoTi=1/5;
nsmooth=10;
immagine(x,y,Teper*code_T/e/1e3/TeoTi,['Tiper' ncycle],[3 5]/TeoTi/2/TeoTi,nsmooth)
immagine(x,y,Tepar*code_T/e/1e3/TeoTi,['Tipar' ncycle],[3 5]/TeoTi/2/TeoTi,nsmooth)
immagine(x,y,Tepar./Teper,['Ti_asym' ncycle],[0.5 1.5],nsmooth)
