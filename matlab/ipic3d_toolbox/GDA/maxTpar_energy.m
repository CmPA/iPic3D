...
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),gsmy2z(ymax*dy),['ZGSMmax' ncycle1],[-3.2 -2.7],5,ncycle1,[],1,'x/R_E','y/R_E','Zgsm [R_E]')


immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),Tepar_max*code_T,['Tepar' ncycle1],[10 25],3,ncycle1,[],3,'x/R_E','y/R_E','T_{e||}[keV]')
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),Teper1_max*code_T,['Teper1' ncycle1],[5 15],3,ncycle1,[],3,'x/R_E','y/R_E','T_{e\perp1}[keV]')
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),Teper2_max*code_T,['Teper2' ncycle1],[5 15],3,ncycle1,[],3,'x/R_E','y/R_E','T_{e\perp2}[keV]')
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),log10(E_max*code_T),['E' ncycle1],[-1 0],3,ncycle1,[],3,'x/R_E','y/R_E','log10(T_{e,bulk}[keV])')
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),log10(adiabatic),['Adiabatic' ncycle1],[0 0],3,ncycle1,[],3,'x/R_E','y/R_E','Adiab1')
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),badiabatic,['AdBz' ncycle1],[0 0],3,ncycle1,[],3,'x/R_E','y/R_E','Adiab2')
