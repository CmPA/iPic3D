...
jrange=max(jrange,1);jrange=min(jrange,ny);
...
Zx_max(i,k)=mean(Zx(i,jrange,k));
Zy_max(i,k)=mean(Zy(i,jrange,k));
Zz_max(i,k)=mean(Zz(i,jrange,k));
...
Vslipx_max(i,k)=mean(Vslipx(i,jrange,k));
Vslipy_max(i,k)=mean(Vslipy(i,jrange,k));
Vslipz_max(i,k)=mean(Vslipz(i,jrange,k));

Vslipperpx_max(i,k)=mean(Vslipperpx(i,jrange,k));
Vslipperpy_max(i,k)=mean(Vslipperpy(i,jrange,k));
Vslipperpz_max(i,k)=mean(Vslipperpz(i,jrange,k));
...
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),J_max*code_J,['J' ncycle1],[-2 2]*0e-10,0,ncycle1,[],6,'x/R_E','y/R_E','J [code units]');
...
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),JdotEp_max,['JdotEp' ncycle1],[-1 1]*1e-10,6,ncycle1,[],6,'x/R_E','y/R_E','JdotEp [code units]');
...
Zxavg=immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),-Vslipperpx_max*code_V,['VslipEperpx' ncycle1],[-2 2]*1e3,3,ncycle1,[],3,'x/R_E','y/R_E','\delta_\perp Vx(gsm) [Km/s]');
Zyavg=immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),Vslipperpy_max*code_V,['VslipEperpz' ncycle1],[-2 2]*1e3,3,ncycle1,[],3,'x/R_E','y/R_E','\delta_perp Vz(gsm) [Km/s]');
Zzavg=immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),Vslipperpz_max*code_V,['VslipEperpy' ncycle1],[-2 2 ]*1e3,3,ncycle1,[],3,'x/R_E','y/R_E','\delta_\perp Vy(gsm) [Km/s]');

immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),sqrt(Zxavg.^2+Zyavg.^2+Zzavg.^2),['VslipEperpavg' ncycle1],[0 1 ]*.5e3,3,ncycle1,[],3,'x/R_E','y/R_E','\delta_\perp V_e [Km/s]');

immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),Vslipperp_max./Va_max,['VslipEperpoVa' ncycle1],[0 1],3,ncycle1,[],3,'x/R_E','y/R_E','\delta_\perp V_e /V_A');
...
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),sqrt(Zxavg.^2+Zyavg.^2+Zzavg.^2),['OHM_avg' ncycle1],[0 1]*2e-1,6,ncycle1,[],3,'x/R_E','y/R_E','\Omega_{avg}/B_0V_{A}');
...
immagine_xy(gsmx([0 Lx]),gsmz2y([0 Lz]),sqrt(Bisxavg.^2+Bisyavg.^2+Biszavg.^2),['Biskamp_avg' ncycle1],[0 1]*1e-3,6,ncycle1,[],3,'x/R_E','y/R_E','Biskamp_avg');
