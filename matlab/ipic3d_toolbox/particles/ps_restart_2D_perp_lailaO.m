...
[totnum,nbinu,xrange,urange]=spaziofasi(x',uperp1',q',0,-vnorm,vnorm);
x1=xmin;x2=xmax;
...
ylabel('f(vperp)','fontsize',14)
xlabel('vperp/c','fontsize',14)
set(gca,'fontsize',[14])
set(gcf,'Renderer','zbuffer');
