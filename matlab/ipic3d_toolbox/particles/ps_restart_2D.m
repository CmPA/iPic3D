...
print('-dpng','-r300',['SP' num2str(is) 'phasespace2stream' num2str(ipy) '.png'])
print('-depsc','-painters',['SP' num2str(is) 'phasespace2stream' num2str(ipy) '.eps'])
figure(2)
...
set(gca,'fontsize',[14])
set(gcf,'Renderer','zbuffer');
['SP' num2str(is) 'distr2stream' num2str(ipy) '.png']
print('-dpng','-r300',['SP' num2str(is) 'distr2stream' num2str(ipy) '.png'])
print('-depsc','-painters',['SP' num2str(is) 'distr2stream' num2str(ipy) '.eps'])
