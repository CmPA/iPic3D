...
%% added for EB
B1x=hdf5read(filename,'/collective/B1x');
B1y=hdf5read(filename,'/collective/B1y');
B1z=hdf5read(filename,'/collective/B1z');
UEB_0=hdf5read(filename,'/collective/UEB_0');
REB_0=hdf5read(filename,'/collective/REB_0');
%%% end added for EB

Bx0=hdf5read(filename,'/collective/Bx0');
By0=hdf5read(filename,'/collective/By0');
Bz0=hdf5read(filename,'/collective/Bz0');
...
%Ox=int8(hdf5read(filename,'/collective/Ox'));
%Oy=int8(hdf5read(filename,'/collective/Oy'));
%Oz=int8(hdf5read(filename,'/collective/Oz'));
%Level=int8(hdf5read(filename,'/collective/gridLevel'));
