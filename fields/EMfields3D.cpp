...
void EMfields3D::endEcalc(double* xkrylov, Grid * grid, VirtualTopology3D * vct, Collective *col)
{
  ...
  if (BSNeeded){
   ...
   bool smoothThrice=true;
   if (smoothThrice){
     if (vct->getCartesian_rank() == 0){
       cout << "I am smoothing E thrice" << endl;
     }
...
/* SidePert */
/*! initiliaze EM for GEM challange, perturbation at the sides */
void EMfields3D::initGEM_SidePert(VirtualTopology3D * vct, Grid * grid, Collective *col) {
  // perturbation localized in X
  double pertX = 0.4;
  double xpert, ypert, exp_pert;
  ...
  if (restart1 == 0) {
    ...
    if (vct->getCartesian_rank() == 0) {
      cout << "------------------------------------------" << endl;
      cout << "Initialize GEM Challenge (MLMD-ready) with Pertubation at the sides" << endl;
      cout << "------------------------------------------" << endl;
      cout << "B0x                              = " << B0x << endl;
      cout << "B0y                              = " << B0y << endl;
      cout << "B0z                              = " << B0z << endl;
	...
	for (int k = 0; k < nzn; k++) {
	  ...
	  // add the initial X perturbation
	  xpert = globalx;
	  xpert= MODULO_2(xpert- Lx/2,Lx) - Lx/2; //mod(xpert-  Lx/2, Lx)- Lx/2;
...
void EMfields3D::initGEMnoPert(VirtualTopology3D * vct, Grid * grid, Collective *col) {
  ...
  if (restart1 == 0) {
    ...
    if (vct->getCartesian_rank() == 0) {
      cout << "------------------------------------------" << endl;
      cout << "Initialize GEM Challenge (MLMD-ready) without Pertubation" << endl;
      cout << "------------------------------------------" << endl;
      cout << "B0x                              = " << B0x << endl;
      cout << "B0y                              = " << B0y << endl;
      cout << "B0z                              = " << B0z << endl;
