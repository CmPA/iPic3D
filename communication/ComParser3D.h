...
inline void makeNodeFace(int nx, int ny, int nz, double ****vector, int ns, double *ghostXrightFace, double *ghostXleftFace, double *ghostYrightFace, double *ghostYleftFace, double *ghostZrightFace, double *ghostZleftFace){
// XFACES  
  int counter=0;
  for (register int j=1; j < ny-1; j++)
    for (register int k=1; k < nz-1; k++){
...
/** prepare ghost cells on 6 faces for communication */
inline void makeCenterFace(int nx, int ny, int nz, double ***vector, double *ghostXrightFace, double *ghostXleftFace, double *ghostYrightFace, double *ghostYleftFace, double *ghostZrightFace, double *ghostZleftFace){
  // XFACES  
  int counter=0;
  for (register int j=1; j < ny-1; j++)
    for (register int k=1; k < nz-1; k++){
...
/** prepare ghost cells on 6 faces for communication */
inline void makeCenterFace(int nx, int ny, int nz, double ****vector, int ns, double *ghostXrightFace, double *ghostXleftFace, double *ghostYrightFace, double *ghostYleftFace, double *ghostZrightFace, double *ghostZleftFace){
  // XFACES  
  int counter=0;
  for (register int j=1; j < ny-1; j++)
    for (register int k=1; k < nz-1; k++){
...
inline void makeNodeEdgeZ(int nx, int ny, int nz, double *faceXleft, double *faceXright, double *ghostXrightYrightZsameEdge, double *ghostXleftYleftZsameEdge, double *ghostXrightYleftZsameEdge, double *ghostXleftYrightZsameEdge){
        int counter = 0;
		int counterLeft = 0;
		int counterRight = 0;
        for (register int j=1; j < ny-1; j++)
...
inline void makeNodeEdgeY(int nx, int ny, int nz, double *faceZleft, double *faceZright, double *ghostXrightYsameZrightEdge, double *ghostXleftYsameZleftEdge, double *ghostXleftYsameZrightEdge, double *ghostXrightYsameZleftEdge){
       int counter = 0;
	   int counterLeft = 0;
	   int counterRight = 0;
       for (register int i=1; i < nx-1; i++)
...
inline void makeNodeEdgeX(int nx, int ny, int nz, double *faceYleft, double *faceYright, double *ghostXsameYrightZrightEdge, double *ghostXsameYleftZleftEdge, double *ghostXsameYleftZrightEdge, double *ghostXsameYrightZleftEdge){
	   int counter = 0;
	   int counterLeft = 0;
	   int counterRight = 0;
	   for (register int i=1; i < nx-1; i++)
...
inline void parseFace(int nx, int ny, int nz, double ***vector, double *ghostXrightFace, double *ghostXleftFace, double *ghostYrightFace, double *ghostYleftFace, double *ghostZrightFace, double *ghostZleftFace){
  // XFACES  
  int counter=0;
  for (register int j=1; j < ny-1; j++)
    for (register int k=1; k < nz-1; k++){
...
/** insert the ghost cells in the 3D phisical vector */
inline void parseFace(int nx, int ny, int nz, double ****vector,int ns, double *ghostXrightFace, double *ghostXleftFace, double *ghostYrightFace, double *ghostYleftFace, double *ghostZrightFace, double *ghostZleftFace){
  // XFACES  
  int counter=0;
  for (register int j=1; j < ny-1; j++)
    for (register int k=1; k < nz-1; k++){
...
inline void addFace(int nx, int ny, int nz, double ***vector, double *ghostXrightFace, double *ghostXleftFace, double *ghostYrightFace, double *ghostYleftFace, double *ghostZrightFace, double *ghostZleftFace,VirtualTopology3D *vct){
  int counter;
...
inline void parseEdgeZ(int nx, int ny, int nz, double ***vector, double *ghostXrightYrightZsameEdge, double *ghostXleftYleftZsameEdge, double *ghostXrightYleftZsameEdge, double *ghostXleftYrightZsameEdge){
...
/** insert the ghost cells Edge Z in the 3D phisical vector */
inline void parseEdgeZ(int nx, int ny, int nz, double ****vector,int ns, double *ghostXrightYrightZsameEdge, double *ghostXleftYleftZsameEdge, double *ghostXrightYleftZsameEdge, double *ghostXleftYrightZsameEdge){
       for(register int i=1; i < (nz - 1); i++){
...
inline void parseEdgeY(int nx, int ny, int nz, double ***vector, double *ghostXrightYsameZrightEdge, double *ghostXleftYsameZleftEdge, double *ghostXleftYsameZrightEdge, double *ghostXrightYsameZleftEdge){
...
/** prepare ghost cell Edge Y for communication */
inline void parseEdgeY(int nx, int ny, int nz,  double ****vector,int ns, double *ghostXrightYsameZrightEdge, double *ghostXleftYsameZleftEdge, double *ghostXleftYsameZrightEdge, double *ghostXrightYsameZleftEdge){
       for(register int i=1; i < (ny - 1); i++){
...
inline void parseEdgeX(int nx, int ny, int nz, double ***vector, double *ghostXsameYrightZrightEdge, double *ghostXsameYleftZleftEdge, double *ghostXsameYleftZrightEdge, double *ghostXsameYrightZleftEdge){
       for(register int i=1; i < (nx - 1); i++){
...
inline void parseEdgeX(int nx, int ny, int nz, double ****vector, int ns, double *ghostXsameYrightZrightEdge, double *ghostXsameYleftZleftEdge, double *ghostXsameYleftZrightEdge, double *ghostXsameYrightZleftEdge){
       for(register int i=1; i < (nx - 1); i++){
