...
void communicateNode(int nx, int ny, int nz, array_ref3_double& _vector, VirtualTopology3D * vct) {
...
/** communicate ghost cells (FOR NODES) */
void communicateNodeBC(int nx, int ny, int nz, array_ref3_double& _vector, int bcFaceXright, int bcFaceXleft, int bcFaceYright, int bcFaceYleft, int bcFaceZright, int bcFaceZleft, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector = _vector.fetch_arr3();
  // allocate 6 ghost cell Faces
  double *ghostXrightFace = new double[(ny - 2) * (nz - 2)];
...
void communicateNodeBC_P(int nx, int ny, int nz, array_ref3_double& _vector, int bcFaceXright, int bcFaceXleft, int bcFaceYright, int bcFaceYleft, int bcFaceZright, int bcFaceZleft, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector=_vector.fetch_arr3();
  // allocate 6 ghost cell Faces
  double *ghostXrightFace = new double[(ny - 2) * (nz - 2)];
...
void communicateNode(int nx, int ny, int nz, array_ref4_double& _vector, int ns, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
...
// PARTICLES
/** SPECIES: communicate ghost cells */
void communicateNode_P(int nx, int ny, int nz, array_ref4_double& _vector, int ns, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ****vector = _vector.fetch_arr4();
...
void communicateCenter(int nx, int ny, int nz, array_ref3_double& _vector, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector = _vector.fetch_arr3();
...
void communicateCenterBoxStencilBC(int nx, int ny, int nz, array_ref3_double& _vector, int bcFaceXright, int bcFaceXleft, int bcFaceYright, int bcFaceYleft, int bcFaceZright, int bcFaceZleft, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector=_vector.fetch_arr3();
  // allocate 6 ghost cell Faces
  double *ghostXrightFace = new double[(ny - 2) * (nz - 2)];
...
// particles
/** communicate ghost cells (FOR CENTERS) with BOX stencil*/
void communicateCenterBoxStencilBC_P(int nx, int ny, int nz, array_ref3_double& _vector, int bcFaceXright, int bcFaceXleft, int bcFaceYright, int bcFaceYleft, int bcFaceZright, int bcFaceZleft, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector=_vector.fetch_arr3();
  // allocate 6 ghost cell Faces
  double *ghostXrightFace = new double[(ny - 2) * (nz - 2)];
...
void communicateNodeBoxStencilBC(int nx, int ny, int nz, array_ref3_double& _vector, int bcFaceXright, int bcFaceXleft, int bcFaceYright, int bcFaceYleft, int bcFaceZright, int bcFaceZleft, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector=_vector.fetch_arr3();
  // allocate 6 ghost cell Faces
  double *ghostXrightFace = new double[(ny - 2) * (nz - 2)];
...
void communicateNodeBoxStencilBC_P(int nx, int ny, int nz, array_ref3_double& _vector, int bcFaceXright, int bcFaceXleft, int bcFaceYright, int bcFaceYleft, int bcFaceZright, int bcFaceZleft, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector=_vector.fetch_arr3();
  // allocate 6 ghost cell Faces
  double *ghostXrightFace = new double[(ny - 2) * (nz - 2)];
...
/** SPECIES: communicate ghost cells */
void communicateCenter(int nx, int ny, int nz, array_ref4_double& _vector, int ns, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ****vector=_vector.fetch_arr4();
...
// /////////// communication + BC ////////////////////////////
void communicateCenterBC(int nx, int ny, int nz, array_ref3_double& _vector, int bcFaceXright, int bcFaceXleft, int bcFaceYright, int bcFaceYleft, int bcFaceZright, int bcFaceZleft, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector=_vector.fetch_arr3();
...
// /////////// communication + BC ////////////////////////////
void communicateCenterBC_P(int nx, int ny, int nz, array_ref3_double& _vector, int bcFaceXright, int bcFaceXleft, int bcFaceYright, int bcFaceYleft, int bcFaceZright, int bcFaceZleft, VirtualTopology3D * vct) {
  timeTasks.start_communicate();
  double ***vector=_vector.fetch_arr3();
